        ...
        <header className="py-6 px-6 border-b border-slate-900 bg-black/80 backdrop-blur-md sticky top-0 z-10">
          <div className="max-w-250 mx-auto flex justify-between items-center">
            ...
            <button
              ...
              className="p-2 mb-4 text-sm font-bold bg-theme-bg border cursor-pointer border-slate-500 text-theme-text rounded-lg shadow-sm hover:opacity-80 transition-opacity"
            >
              <img
                src={moonIcon}
